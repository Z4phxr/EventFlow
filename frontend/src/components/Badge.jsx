const variantStyles = {
  ...
  // Geocoding status
  geocoded: 'bg-emerald-100 text-emerald-700 border-emerald-200',
  'not-geocoded': 'bg-amber-100 text-amber-700 border-amber-200',
  
  // Registration status
  REGISTERED: 'bg-green-100 text-green-700 border-green-200',
  REGISTRATION_CANCELLED: 'bg-red-100 text-red-700 border-red-200',
