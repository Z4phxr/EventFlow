            ...
            {result && (
              <div className="text-center py-8">
                <div className={`w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 ${
                  result.alreadyAccepted ? 'bg-blue-100' : 'bg-gray-100'
                }`}>
                ...
                <h2 className="text-xl font-semibold text-gray-900 mb-2">
                  {result.alreadyAccepted ? 'Already Accepted' : 
                   result.alreadyDeclined ? 'Already Declined' :
                   result.expired ? 'Invitation Expired' : 
                   'Invitation Declined'}
                </h2>
